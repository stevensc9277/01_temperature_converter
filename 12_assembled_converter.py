...
class Converter:
    def __init__(self, parent):
        ...
        self.calc_hist_button = Button(self.hist_help_frame, font="Arial, 12 bold", text="Calculation history", width=15, command=lambda: self.temp_convert(self.all_calc_list))
